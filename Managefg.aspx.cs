...
public partial class Managefg : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter sda = new SqlDataAdapter("select ID,title,addtime from fagui", con);
        sda.Fill(ds, "mclass");
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strsql = "delete from fagui where ID='" + id + "'";
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string strsql = "update fagui set title='" + title + "', addtime='" + addtime + "'  where ID='" + id + "'";
        SqlCommand cmd = new SqlCommand(strsql, con);
        con.Open();
