<%@ Page Language="C#" AutoEventWireup="true" CodeFile="guanlixx.aspx.cs" Inherits="guanlixx" %>
...
<div class="Popular">
   ...
   <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" Width="700px" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="upfcxx.aspx?id={0}"
                HeaderText="更新" Text="更新" />
            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" />
        </Columns>
        <FooterStyle BackColor="#E60012" Font-Bold="True" ForeColor="White" />
        <RowStyle BackColor="#EFF3FB" />
        <EditRowStyle BackColor="#2461BF" />
        <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
        <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
        <HeaderStyle BackColor="#E60012" Font-Bold="True" ForeColor="White" />
