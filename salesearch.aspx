<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salesearch.aspx.cs" Inherits="salesearch" %>
...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> &gt; <a href="#">查询房源</a></span>
...
<div class="ListTop01">
<ul>
    <li class="current"><a href="javascript:void(0)" onclick="doSearchHouseType('')">查询结果</a></li>
