<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showfcxx.aspx.cs" Inherits="showfcxx" %>
...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> &gt; <a href="">显示房产信息</a></span>
 ...
 <div class="left710 blockIndex">
   ...
   <div class="left710 blockIndex">
      <div class="PicInfo">
        ...
        <div class="TW">
          <ul class="InTop">
            <li><strong>出售总价：</strong><del><b><asp:Label ID="Label1" runat="server" 
                    Text=""></asp:Label>
...
<DIV style="MARGIN-TOP: 0px; MARGIN-BOTTOM: 0px; height: 288px; font-size:15px;  ">
