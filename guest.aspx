            ...
            <tr>
                <td >
                    ...
                    <asp:DataList ID="DataList1" runat="server" 
                        Style="position: relative; top: 0px; left: 0px;  width: 771px;" 
                        OnItemDataBound="DataList1_ItemDataBound">
                        <ItemTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" style="border-top: #e8e8e8 1px solid;
                                left: 1px; width: 700px; position: relative; top: 0px; height: 32px">
                                <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="left: 1px; width: 700px;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 431px; border-bottom: #e8e8e8 1px solid; height: 121px">
                                        <div style="left: 3px; width: 650px; position: relative; top: 0px;
                                            text-align: left; height: 82px;">
                                            <%#DataBinder.Eval(Container.DataItem, "content")%>
                                            <br />——————————————————<br />
                                            管理员回复：<%#DataBinder.Eval(Container.DataItem, "reply")%>
                                            </div>
                                        <div style="left: 2px; width: 650px; position: relative; height: 25px;
                                            text-align: right">
                            ...
                            <table border="0" cellspacing="0" style="border-top: #e8e8e8 1px solid; left: 1px;
                                width: 700px; position: relative; top: 0px; height: 13px">
                                <tr>
