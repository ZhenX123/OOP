<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabuxx.aspx.cs" Inherits="fabuxx" %>
...
<div class="Popular">
   ...
   <table style=" width:690px;" >类别选房屋出租总价就不填:<tr>
    ...
    <tr>
        <td style="width:780px; height:25px; text-align:center;" colspan="2">
            <asp:Button ID="Button1" runat="server" Text="提交" OnClick="Button1_Click" 
                Height="29px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Text="重置" Height="29px" 
