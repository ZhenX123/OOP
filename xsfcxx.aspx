<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xsfcxx.aspx.cs" Inherits="xsfcxx" %>
...
<div class="Popular">
   ...
   <div class="left750 blockIndex">
      <div class="PicInfo">
        <div class="InfoTitle">
          <p><b><asp:Label ID="Label14" runat="server" Text=""></asp:Label></b></p>
          <br>
          <div class="weibo">
 </div>
        </div>
        <div class="InfoPhoto">
          <div id="infoPohto">
          <a href="#" rel="ImgGroup">
              <asp:Image ID="Image1" runat="server"  Width="300"  ImageUrl="" Height="266" />
              </a>
          </div>
       
          <p class="signage"></p><br>
        </div>
        <div class="TW">
          <ul class="InTop">
            <li><strong>房屋价格：</strong><del><b><asp:Label ID="Label1" runat="server" 
                    Text=""></asp:Label>
                </b></del>  （单价：<asp:Label ID="Label2" runat="server" Text=""></asp:Label>
                ）</li>
            <li><strong>房屋面积：</strong><del><asp:Label ID="Label3" runat="server" Text=""></asp:Label></del></li>
            <li><strong>房屋户型：</strong><asp:Label ID="Label4" runat="server" Text=""></asp:Label></li>
            <li><strong>联系电话：</strong><asp:Label ID="Label5" runat="server" Text=""></asp:Label></li>
          </ul>
<span id="agentmobile1"> </span>
 
          <dl>
            <dd><strong>建造年代：</strong><asp:Label ID="Label6" runat="server" Text=""></asp:Label></dd>
            <dd><strong>楼&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;层：</strong> <asp:Label ID="Label7" runat="server" Text=""></asp:Label></dd>
            <dd><strong>房屋朝向：</strong><asp:Label ID="Label8" runat="server" Text=""></asp:Label></dd>
            <dd><strong>装&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修：</strong> <asp:Label ID="Label9" runat="server" Text=""></asp:Label></dd>
            <dd><strong>产权性质：</strong> <asp:Label ID="Label10" runat="server" Text=""></asp:Label></dd>
            <dd><strong>更新时间：</strong> <asp:Label ID="Label11" runat="server" Text=""></asp:Label></dd>
            <dt><strong>楼盘名称：</strong><asp:Label ID="Label12" runat="server" Text=""></asp:Label></dt>
          </dl>
        </div>
      </div>

  
  <div class="present"><!--<img src="/Resouce/images/present.gif" width="725" height="138" />--></div>
        <div class="cellDescript" id="houseDescript">
            <h4><strong>房源描述</strong></h4>
            <div class="descript">
...
<DIV style="MARGIN-TOP: 0px; MARGIN-BOTTOM: 0px; height: 288px;">
<table width="655"><tr><td>
