<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listfagui.aspx.cs" Inherits="listfagui" %>
...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> &gt; <a href="">显示法规信息</a></span>
...
<div class="Popular">
 ...
 <div class="left710 blockIndex">
        ...
        <div class="cellDescript" id="houseDescript">
           ...
           <table width="700">
  <tr>
    <td height="57" align="center">&nbsp;<font color="#FF0000" size="6"><strong><b><del><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></del></b></strong></font>
       <br><hr>
  ...
  <tr>
    <td height="500" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font  size="3"><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></font></td>
  </tr>
</table>
