<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiugaimy.aspx.cs" Inherits="xiugaimy" %>
            ...
            <tr>
                ...
                <td style="width: 9px; height: 29px"><FONT color="#ff0000">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox3"
                                    ErrorMessage="姓名不允许为空"></asp:RequiredFieldValidator></FONT ></td>
            </tr>
              <tr>
                <td  align=right class="style1">
                    性别</td>
             ...
             <tr>
                ...
                <td style="width: 9px; height: 29px"><FONT color="#ff0000">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox4"
                                    ErrorMessage="电话不允许为空"></asp:RequiredFieldValidator></FONT ></td>
            </tr>
              <tr>
                <td  align=right class="style1">
                    邮箱</td>
                ...
                <td style="width: 9px; height: 29px"><FONT color="#ff0000">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox5"
                                    ErrorMessage="邮箱不允许为空"></asp:RequiredFieldValidator></FONT ></td>
            </tr>
              <tr>
                <td  align=right class="style1">
                    QQ</td>
                ...
                <td style="width: 9px; height: 29px"><FONT color="#ff0000">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox6"
                                    ErrorMessage="QQ不允许为空"></asp:RequiredFieldValidator></FONT ></td>
            </tr>
