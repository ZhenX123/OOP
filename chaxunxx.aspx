<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chaxunxx.aspx.cs" Inherits="chaxunxx" %>
...
<div class="navbar">
    ...
    <li><a target="_blank" href="login.aspx" title="会员登录"> </a></li>
        ...
        <li><a target="_blank" title="行业新闻" href="New.aspx">行业新闻</a></li>
    ...
    <div class="left710 blockIndex">
     ...
     <table width="700" align="center">
                    ...
                    <asp:GridView ID="gvAdminInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
                        BorderColor="#E60012" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="#333333"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="lc" HeaderText="楼层" />
                              <asp:BoundField DataField="addtime" HeaderText="日期" />
                                     <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="xsfcxx.aspx?id={0}"
