<%@ Page Language="C#" AutoEventWireup="true" CodeFile="upfcxx.aspx.cs" Inherits="upfcxx" %>
...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> &gt; <a href="mycenter.aspx">用户中心</a></span>
...
<div class="Popular">
    <div class="Populartext"><span>   用户中心   </span></div>
    <div class="Popularlist">
        <ul>
        <li>
           <p><b>   <del>个人信息管理 </del>  </b></p>
            <p><a href="xiugaimy.aspx" target="_blank" title="修改资料">修改个人资料</a></p>
            
        </li>
        <br>
        <li>
        <p><b>  <del> 信息发布管理 </del>  </b></p>
            <p><a href="fabuxx.aspx" target="_blank" title="发布信息">发布信息</a></p>
             <p><a href="guanlixx.aspx" target="_blank" title="发布信息">信息管理</a></p>
              <p><a href="chaxunxx.aspx" target="_blank" title="发布信息">信息查询</a></p>
              
               
        </li>
        <br>
        <li>
        <p><b>  <del> 系统管理 </del>  </b></p>
            
              
               <p><a href="tccz.aspx" target="_blank" title="退出操作">退出操作</a></p>
        </li><br><br><br><br>
        </ul>
   ...
   <table style=" width:690px;" ><tr>
<td style=" width:25%; height:25px; text-align:right;">
    <asp:Label ID="Label1" runat="server" Text="信息标题："></asp:Label></td>
<td style=" width:76%; height:25px;text-align:left;">
    ...
    <tr>
        ...
        <td style="width:76%; height: 25px; text-align: left">
            <asp:DropDownList ID="DropDownList1" runat="server" Width="71px">
                <asp:ListItem Selected="True">二手房出售</asp:ListItem>
                <asp:ListItem>房屋出租</asp:ListItem>
            </asp:DropDownList></td>
    </tr>
    <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label3" runat="server" Text="小区："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox2"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label4" runat="server" Text="房型："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox3"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label5" runat="server" Text="单价："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
     ...
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label6" runat="server" Text="总价："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox5"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label7" runat="server" Text="面积："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox6"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label8" runat="server" Text="楼层："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox7"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
        ...
        <td style="width: 76%; height: 25px; text-align: left">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox8"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label11" runat="server" Text="建造年代："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox9"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label12" runat="server" Text="房屋朝向："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox10"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label13" runat="server" Text="装修："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox11" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox11"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label14" runat="server" Text="产权性质："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox12" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox12"></asp:RequiredFieldValidator></td>
    </tr>
     <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label15" runat="server" Text="房源描述："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:TextBox ID="TextBox13" runat="server" Height="124px" TextMode="MultiLine" 
                Width="298px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="不能为空！" ControlToValidate="TextBox13"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td style="width: 25%; height: 25px; text-align: right">
            <asp:Label ID="Label10" runat="server" Text="房屋图片："></asp:Label></td>
        <td style="width: 76%; height: 25px; text-align: left">
            <asp:FileUpload ID="FileUpload1" runat="server" />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="FileUpload1"
                ErrorMessage="必须上传图片！"></asp:RequiredFieldValidator></td>
    </tr>
   
    <tr>
        <td style="width:780px; height:25px; text-align:center;" colspan="2">
