<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mycenter.aspx.cs" Inherits="mycenter" Debug=true %>
...
<div class="Popular">
   ...
   <ul>
   <li>
   <p> <b><asp:Label ID="Label2" runat="server" Text=""></asp:Label></b> 你是：  <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
       
       </p>
       <br>
   <p>  </p>
   <p>  欢迎进入用户中心，选择左边功能菜单进行操作!</p>
   </li>
   </ul>
