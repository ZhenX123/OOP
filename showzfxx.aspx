<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showzfxx.aspx.cs" Inherits="showzfxx" %>
 ...
 <div class="left710 blockIndex">
   ...
   <div class="left710 blockIndex">
      <div class="PicInfo">
        ...
        <div class="TW">
          <ul class="InTop">
            <li><strong>出租价格：</strong><del><b><asp:Label ID="Label2" runat="server" 
                    Text=""></asp:Label>
                </b></del>  </li>
...
<DIV style="MARGIN-TOP: 0px; MARGIN-BOTTOM: 0px; height: 288px; font-size:15px; class=bdyItmPrt">
