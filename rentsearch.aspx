<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rentsearch.aspx.cs" Inherits="rentsearch" %>
...
<asp:DataList ID="DataList1" runat="server" Style="position: relative"  Width="700px">
        ...
        <div id="S21QKWS3-AA40680">
            <ul>
            <li class="Listingspic"><a href="showzfxx.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>" target="_blank" title="<%#DataBinder.Eval(Container.DataItem,"xq")%>"><img src="Images/loding.gif" src1="<%#DataBinder.Eval(Container.DataItem,"imgs")%>" /></a></li>

            <li class="baseBox"><p class="title"><a href="showzfxx.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>" target="_blank"><%#DataBinder.Eval(Container.DataItem,"bt")%></a></p>
                <p class="Price">
                    <b>￥<del><%#DataBinder.Eval(Container.DataItem,"dj")%></del> </b>
                    <span>                            <strong></strong></span>
                </p>
            </li>
            <li class="site">
                <p class="address"><cite>小区：</cite><%#DataBinder.Eval(Container.DataItem,"xq")%></p>
                <p><i>房型：<%#DataBinder.Eval(Container.DataItem,"fx")%></i><cite><em>面积：<%#DataBinder.Eval(Container.DataItem,"mj")%></em></cite></p>                
                <p><cite><em>楼层：<%#DataBinder.Eval(Container.DataItem,"lc")%></em></cite></p>               
            </li>
            <li class="Contrast">
