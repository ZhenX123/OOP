<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fagui.aspx.cs" Inherits="fagui" %>
...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> &gt; <a href="fagui.aspx">行业法规</a></span>
...
<div class="ListTop01">
<ul>
    <li class="current"><a href="javascript:void(0)" onclick="doSearchHouseType('')">行业法规</a></li>
  ...
  <asp:DataList ID="DataList1" runat="server" Style="position: relative"  Width="700px">
                        <ItemTemplate>
                                       ...
                                       <li><A href='listfagui.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>'>
                                                ...
                                                </A><span>{<%#DataBinder.Eval(Container.DataItem, "addtime", "{0:yyyy-MM-dd}").ToString()%>}</span></li>
                                    </ItemTemplate>
                                    </asp:DataList>
                                    </div>
