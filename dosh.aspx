<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dosh.aspx.cs" Inherits="dosh" %>
...
<body>
    ...
    <div>
     <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" Width="900px" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None">
        <Columns>
