...
<div class="crumbs">
    <span>您当前位置：<a href="index.aspx">首页</a> </span>
...
<div class="ListTop01">
<ul>
    <li class="current"><a href="javascript:void(0)" onclick="doSearchHouseType('')">所有房源</a></li>
...
<script> 
    function btnOrderDoSearch(id,css){
        id=parseInt(id);
        if(css=="BTN screenUp"){
            doSearch({'order':id-1});
        }
        else if (css == "BTN screenDown") {
            doSearchSubmit({ 'order': id,'p':1  });
        }
        else {
            doSearchSubmit({ 'order': id  - 1,'p':1 });
        }
    }    
</script>
    ...
    <div class="Horizontal" id="container" style="position:relative;">
...
<script> 
   ...
   <asp:DataList ID="DataList1" runat="server" Style="position: relative"  Width="700px">
                        <ItemTemplate>
        <div id="S21QKWS3-AA40680">
            <ul>
            <li class="Listingspic"><a href="showfcxx.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>" target="_blank" title="<%#DataBinder.Eval(Container.DataItem,"xq")%>"><img src="Images/loding.gif" src1="<%#DataBinder.Eval(Container.DataItem,"imgs")%>" /></a></li>

            <li class="baseBox"><p class="title"><a href="showfcxx.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>" target="_blank"><%#DataBinder.Eval(Container.DataItem,"bt")%></a></p>
                <p class="Price">
                    <b>￥<del><%#DataBinder.Eval(Container.DataItem,"zj")%></del> </b>
                    <span>                            <strong></strong></span>
                </p>
            </li>
            <li class="site">
                <p class="address"><cite>小区：</cite><%#DataBinder.Eval(Container.DataItem,"xq")%></p>
                <p><i>房型：<%#DataBinder.Eval(Container.DataItem,"fx")%></i><cite><em>单价：<%#DataBinder.Eval(Container.DataItem,"dj")%></em></cite></p>                
                <p><i><cite>面积：</cite><%#DataBinder.Eval(Container.DataItem,"mj")%></i><cite><em>楼层：<%#DataBinder.Eval(Container.DataItem,"lc")%></em></cite></p>               
            </li>
            <li class="Contrast">
<span class="only"><i></i></span>           </li>
            </ul>
        </div>
       </ItemTemplate>
                        <SeparatorTemplate>
...
<div class="PK" style="display:none">
 ...
 <div class="hotAgent classify">
<p class="Publictop"><strong>行业新闻</strong></p>
<div class="newslists">
   
       <asp:DataList ID="DataList2" runat="server" Style="position: relative " Width="180px" >
                        <ItemTemplate>
                                   
                                       <li><A href='listnews.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>'>
                                                    <%#Left(Convert.ToString(DataBinder.Eval(Container.DataItem, "title")),12)%>
                                                </A></li>
                                    </ItemTemplate>
                                    </asp:DataList>
 ...
 <div class="hotAgent classify">
<p class="Publictop"><strong>行业法规</strong></p>
<div class="newslists">
   
       <asp:DataList ID="DataList3" runat="server" Style="position: relative"  Width="180px">
                        <ItemTemplate>
                                   
                                       <li><A href='listfagui.aspx?id=<%#DataBinder.Eval(Container.DataItem,"ID")%>'>
                                                    <%#Left(Convert.ToString(DataBinder.Eval(Container.DataItem, "title")),12)%>
                                                </A></li>
                                    </ItemTemplate>
                                    </asp:DataList>
