                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; position: relative;
                        ...
                        <tr>
                            <td style="height: 156px">
                                <asp:Label ID="Label1" runat="server" Style="position: relative; left: -17px; top: -125px;" Text="回复内容："></asp:Label>
                                <asp:TextBox ID="txtReply" runat="server" Style="position: relative" Height="141px" TextMode="MultiLine" Width="306px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="height: 33px">
                                <asp:Button ID="Button1" runat="server" Style="position: relative" Text="提交" OnClick="Button1_Click" />&nbsp;<asp:Button
                                    ID="Button2" runat="server" Style="left: 10px; position: relative" Text="清空" OnClick="Button2_Click" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
