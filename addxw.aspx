<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addxw.aspx.cs" Inherits="addxw" validateRequest="false" %>
            ...
            <tr>
             ...
             <tr>
                <td  align=right style="width: 9574px">
                 名称</td>
                <td style="width: 253px; height: 29px" align=left> <asp:TextBox ID="TextBox1" runat="server" Width="406px" ></asp:TextBox>     </td>
